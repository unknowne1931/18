...
const Question = () => {
  ...
  useEffect(()=>{
    axios.post("https://stawro.xyz/verify/account/key",{ip})
    .then(res =>{
    ...
    fetch("https://ipapi.co/json")
        ...
        fetch(`https://stawro.xyz/question/singel/verify/data/01/${ip}`)
        .then(res => res.json())
    ...
    fetch(`https://stawro.xyz/question/singel/verify/data/01/sakhd/sjkh/dsf/dfsd/${ip}`)
    .then(res => res.json())
    .then(data => setUpii1(data))

    fetch(`https://stawro.xyz/question/singel/verify/data/01/sakhd/${ip}`)
    .then(res => res.json())
  ...
  const Button1 = () =>{
    resetTimer();
    const Option  = "A"
    axios.post("https://stawro.xyz/answer/check/question/correct/or/wrong",{Option, Qno, ip})
    .then(res =>{
      if(res.data.Status === "OK"){
